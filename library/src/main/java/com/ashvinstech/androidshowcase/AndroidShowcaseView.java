...
import com.ashvinstech.androidshowcase.shape.CircleShape;
import com.ashvinstech.androidshowcase.shape.OvalShape;
import com.ashvinstech.androidshowcase.R;
import com.ashvinstech.androidshowcase.shape.NoShape;
import com.ashvinstech.androidshowcase.shape.RectangleShape;
import com.ashvinstech.androidshowcase.shape.Shape;
import com.ashvinstech.androidshowcase.target.Target;
import com.ashvinstech.androidshowcase.target.ViewTarget;


/**
 * Helper class to show a sequence of showcase views.
 */
public class AndroidShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public AndroidShowcaseView(Context context) {
        super(context);
        init(context);
    }

    public AndroidShowcaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AndroidShowcaseView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AndroidShowcaseView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void removeShowcaseListener(AndroidShowcaseSequence showcaseListener) {
    ...
    public static class Builder {
        ...
        final AndroidShowcaseView showcaseView;
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new AndroidShowcaseView(activity);
        }
        ...
        public AndroidShowcaseView build() {
        ...
        public AndroidShowcaseView show() {
            build().show(activity);
            return showcaseView;
        }
    }
