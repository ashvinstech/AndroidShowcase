...
public class AndroidShowcaseSequence implements IDetachedListener {

    PrefsManager mPrefsManager;
    Queue<AndroidShowcaseView> mShowcaseQueue;
    ...
    public AndroidShowcaseSequence(Activity activity) {
        mActivity = activity;
        mShowcaseQueue = new LinkedList<>();
    }

    public AndroidShowcaseSequence(Activity activity, String sequenceID) {
        this(activity);
        this.singleUse(sequenceID);
    }

    public AndroidShowcaseSequence addSequenceItem(View targetView, String content, String dismissText) {
        addSequenceItem(targetView, "", content, dismissText);
        return this;
    }

    public AndroidShowcaseSequence addSequenceItem(View targetView, String title, String content, String dismissText) {

        AndroidShowcaseView sequenceItem = new AndroidShowcaseView.Builder(mActivity)
    ...
    public AndroidShowcaseSequence addSequenceItem(AndroidShowcaseView sequenceItem) {
    ...
    public AndroidShowcaseSequence singleUse(String sequenceID) {
        mSingleUse = true;
    ...
    private void showNextItem() {
        ...
        if (mShowcaseQueue.size() > 0 && !mActivity.isFinishing()) {
            AndroidShowcaseView sequenceItem = mShowcaseQueue.remove();
    ...
    @Override
    public void onShowcaseDetached(AndroidShowcaseView showcaseView, boolean wasDismissed, boolean wasSkipped) {
    ...
    public interface OnSequenceItemShownListener {
        void onShow(AndroidShowcaseView itemView, int position);
    }

    public interface OnSequenceItemDismissedListener {
        void onDismiss(AndroidShowcaseView itemView, int position);
    }
